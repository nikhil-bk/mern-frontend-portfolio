...
const Header = () => {
    return (
      ...
      />
             ...
             <div className="cv">
                 <span><b>Cv:</b> <a href="https://drive.google.com/file/d/15S3PR462jo7S206SbK5TCDifo9J5XXNu/view?usp=drive_link" target="_blank" rel="noreferrer"><i className="fas fa-file-pdf"></i></a></span>
             </div>
