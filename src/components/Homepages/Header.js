...
const Header = () => {
    return (
      ...
      />
             ...
             <div className="cv">
                 <span><b>Cv:</b> <a href="https://drive.google.com/file/d/1uqRqyMGd95JjZY-AXnQjv1qLSOs2FPl3/view?usp=sharing" target="_blank" rel="noreferrer"><i className="fas fa-file-pdf"></i></a></span>
             </div>
